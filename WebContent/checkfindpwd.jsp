...
<tbody>
<%
List<FindPwd> flist = (List<FindPwd>)session.getAttribute("flist");
for(FindPwd fpwd : flist) {
	out.println("<tr>");
	out.println("<td>"+fpwd.getUserid()+"</td>");
	out.println("<td>"+fpwd.getUserphone()+"</td>");
	out.println("<td>"+fpwd.getUseremail()+"</td>");
